          ...
          <ul class="navbar-nav justify-content-end">
            ...
            @if(isset($us))
              <li class="nav-item dropdown">
                <ul class="navbar-nav mr-auto">
                  <li class="nav-item">
                    <a href="{{route('inbox', [$token])}}" class="nav-link {{$_SERVER['REQUEST_URI'] == '/' ? ' active' : ''}}">All Mails</a>
                  </li>
                </ul>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <h5 class="dropdown-item-text mb-0">{{ $us->displayName }}</h5>
                  <p class="dropdown-item-text text-muted mb-0">{{$us->mail }}</p>
