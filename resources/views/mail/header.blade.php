 ...
 <div class="mail-box">
                  <aside class="sm-side">
                      ...
                      <ul class="inbox-nav inbox-divider">
                          ...
                          <li class="active"><a href="{{ url('/'.$r->displayName.'/'. $token .'/'. $r->parentFolderId .'')}}"><i class="fa fa-inbox"></i> {{$r->displayName}} </a>
                      ...
                      <ul class="inbox-nav inbox-divider">
                      <li class="active"><a href="{{ route('board', $token)}}" ><i class="fa fa-inbox"></i> Board </a>
                      </li>
                      </ul>
                      <ul class="inbox-nav inbox-divider">
                    <li class="active">
