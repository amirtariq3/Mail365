    ...
    <div class="inbox-body">
       ...
       <div class="col-lg-9 email-content">
            ...
            <div class="email-head-sender d-flex align-items-center justify-content-between flex-wrap">
              <div class="d-flex align-items-center">
                ...
                <div class="sender d-flex align-items-center">
                  <a href="#">{{$r->sender->emailAddress->name}}</a> ({{$r->sender->emailAddress->address}})
          ...
          <div class="email-body">
            ...
            <br>
            <p><strong>Body:</strong>{!! $r->body->content; !!}</p>
          </div>
          </div>
          <a href="{{ url('/reply/ '. $token .'/'. $r->id .'')}}" class="btn btn-primary" > Reply </a> | <a href="{{ url('/forward/ '. $token .'/'. $id.'')}}" class="btn btn-primary" > Forward </a>
          @endif
          @endforeach
<br><br><br>
          ...
          <div class="d-flex flex-column comment-section">
            ...
            <div class="bg-white p-2">
                <div class="d-flex flex-row user-info"><img class="rounded-circle" src="https://i.imgur.com/RpzrMR2.jpg" width="40">
                    <div class="d-flex flex-column justify-content-start ml-2"><span class="d-block font-weight-bold name">Admin</span><span class="date text-black-50">Shared publicly - Jan 2020</span></div>
                </div>
                <div class="mt-2">
