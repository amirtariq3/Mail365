                          ...
                          <table class="table table-inbox table-hover">
                            ...
                            @foreach ($arr1 as $r)
                              ...
                              <tr class="unread">
                                  ...
                                  <td class="view-message  dont-show"><a href="{{ url('/detail/ ' . $token . '/' . $r->id .'')}}">{{$r->toRecipients[0]->emailAddress->address}}</a></td>
                                  {{-- {{dd($r)}} --}}
                                  <td class="view-message ">{{$r->subject}}</td>
                                  <td class="view-message  inbox-small-cells"><i class="fa fa-paperclip"><a href="{{ url('/delete/ ' . $token . '/' . $r->id .'')}}" onclick="return confirm('Are you sure you want to delete this Email?');">delete</a></i></td>
