                  ...
                  <aside class="lg-side">
                      <div class="inbox-head">
                          ...
                          <table class="table table-inbox table-hover">
                            <tbody>
                                <?php
                                 $data="AAMkADQ0MTA1YWZmLTdhMjAtNDM5OS1hODc4LTQwYmRmMTA1NjIwZQAuAAAAAAC2FyRaMjr3QI4S4hLsOyjBAQBCmdKVgqrvQqshNpasfUyiAAAAAAEKAAA=";
//echo $data;die;
//$d=sha1($data);
...
//echo $d;die;
                            ...
                            @foreach ($arr1 as $r)
                              ...
                              <tr class="unread">
                                  ...
                                  <td class="view-message  dont-show"><a href="{{ url('/detail/ ' . $token . '/' . $r->id .'')}}">{{$r->sender->emailAddress->name}}</a></td>
