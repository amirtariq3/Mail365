...
<aside class="lg-side">
                ...
                <div class="email-head">
                    <div class="email-head-sender d-flex align-items-center justify-content-between flex-wrap">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="#">{{$arr1->sender->emailAddress->address}}</a>
                        ...
                        <div class="date">{{$arr1->receivedDateTime}}</div>
                    </div>
                </div>
                <?php $body= $arr1->body->content;  ?>
        ...
        <form method="post" action="">
            @csrf
            <div class="form-group">
            <label for="exampleFormControlInput1">Forward To</label>
        ...
        {{-- <a href="{{ url('/reply/ '. $token .'/'. $r->id .'')}}" class="btn btn-primary" > Reply </a> | <a href="" class="btn btn-primary" > Forward </a> --}}
      </div>
