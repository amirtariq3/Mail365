...
.dropdown-content {
  ...
  background-color: #d5d7de !important;
                       ...
                       <div class="">
                        ...
                        <tbody>
                          ...
                          <tr class="unread">
                              ...
                              <td class="jumbotron" id="subject {{$val->id}}"  >



                                <a href="{{ url('/detail/ ' . $token . '/' . $val->id .'')}}">  {{$val->sender->emailAddress->name}}</a>

                                @if ($val->categories)
                                {{$val->categories[0]}}   <a href="{{route('unassign', [$val->id])}}" >(del)</a>
                                @endif
                                        ...
                                        <li>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-content">
                                                    ...
                                                    <a class="dropdown-item" href="{{route('move', [$val->id, $folder->id])}}"> {{$folder->displayName}} </a>
                                                    @endforeach
                                                </div>
                                                ...
                                                <div class="dropdown-content">
                                                    ...
                                                    @foreach ($arr2 as $folder)
                                                    <a class="dropdown-item" href="{{route('copy', [$val->id, $folder->id])}}"> {{$folder->displayName}}</a>
                                                    @endforeach
                                                </div>
                                              </div>
                                        </li>
                                        <li>
                                            <div class="dropdown1">
                                                ...
                                                <div class="dropdown-content1">
                                                    @foreach($data as $cat)
                                                    <a class="dropdown-item" href="{{route('assign', [$val->id,$cat['displayName']])}}">{{$cat['displayName']}}</a>
                                                    @endforeach

                                                    <a class="dropdown-item" href="{{route('assign', [$val->id,$cat['displayName']])}}">    Add Category</a>

                                                    <a class="dropdown-item" href="{{route('add_category')}}">    Add Category</a>
                                                    @if ($val->isRead == true)
                                                    <a class="dropdown-item" href="{{route('unread', [$val->id])}}">    Mark as Unread</a>
                                                    @else
                                                    <a class="dropdown-item" href="{{route('read', [$val->id])}}">    Mark as Read</a>
                                                    @endif
                                                </div>
                                                </div>
                                        </li>
                              ...
                              <td class="view-message  inbox-small-cells"><i class="fa fa-paperclip"><a href="{{ url('/delete/ ' . $token . '/' . $val->id .'')}}" onclick="return confirm('Are you sure you want to delete this Email?');">delete</a></i></td>
                              <td class="view-message  text-right">{{$val->receivedDateTime}}</td>
